      ...
      <Grid container spacing={3}>
        ...
        <Grid item xs={12} md={8}>
          ...
          <GlassCard sx={{ p: 4, mt: 3 }}>
            <Typography variant="h6" sx={{ fontWeight: 900, mb: 3, display: 'flex', alignItems: 'center' }}>
          ...
          <GlassCard sx={{ p: 4, mt: 3 }}>
            ...
            <Grid container spacing={2}>
              <Grid item xs={6} sm={3}>
                <Box sx={{ p: 2, textAlign: 'center', bgcolor: 'rgba(245, 158, 11, 0.1)', borderRadius: 2, border: '1px solid rgba(245, 158, 11, 0.2)' }}>
                  <Typography variant="h4" sx={{ fontWeight: 900, color: '#92400e' }}>{totalYears}+</Typography>
                  <Typography variant="caption" sx={{ color: 'text.secondary', fontWeight: 700, textTransform: 'uppercase' }}>Years</Typography>
                </Box>
              </Grid>
              <Grid item xs={6} sm={3}>
                <Box sx={{ p: 2, textAlign: 'center', bgcolor: 'rgba(59, 130, 246, 0.1)', borderRadius: 2, border: '1px solid rgba(59, 130, 246, 0.2)' }}>
                  <Typography variant="h4" sx={{ fontWeight: 900, color: '#1e40af' }}>{totalProducts}+</Typography>
                  <Typography variant="caption" sx={{ color: 'text.secondary', fontWeight: 700, textTransform: 'uppercase' }}>Products</Typography>
                </Box>
              </Grid>
              <Grid item xs={6} sm={3}>
                <Box sx={{ p: 2, textAlign: 'center', bgcolor: 'rgba(16, 185, 129, 0.1)', borderRadius: 2, border: '1px solid rgba(16, 185, 129, 0.2)' }}>
                  <Typography variant="h4" sx={{ fontWeight: 900, color: '#166534' }}>{uniqueCustomers}+</Typography>
                  <Typography variant="caption" sx={{ color: 'text.secondary', fontWeight: 700, textTransform: 'uppercase' }}>Customers</Typography>
                </Box>
              </Grid>
              <Grid item xs={6} sm={3}>
                <Box sx={{ p: 2, textAlign: 'center', bgcolor: 'rgba(236, 72, 153, 0.1)', borderRadius: 2, border: '1px solid rgba(236, 72, 153, 0.2)' }}>
                  <Typography variant="h4" sx={{ fontWeight: 900, color: '#9f1239' }}>5★</Typography>
                  <Typography variant="caption" sx={{ color: 'text.secondary', fontWeight: 700, textTransform: 'uppercase' }}>Rating</Typography>
                </Box>
              </Grid>
            </Grid>
          </GlassCard>
